...
namespace Encuestadora_Identity2.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [Compare("Password", ErrorMessage = "La contraseña no es la misma.")]
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    await _emailSender.SendEmailAsync(Input.Email, "Confirme su correo",
                        $"Por favor confirme su correo <a href='{HtmlEncoder.Default.Encode(callbackUrl)}'>Haga click aqui</a>.");
